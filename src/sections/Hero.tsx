          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-slate-400 text-lg sm:text-xl max-w-lg">
                Your trusted web development company and software partner in Sri Lanka. We engineer intelligent web applications, AI solutions, and scalable platforms for forward-thinking enterprises globally.
              </p>
            </div>
